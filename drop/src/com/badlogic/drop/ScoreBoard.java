...
public class ScoreBoard implements Screen {
	...
	public ScoreBoard(final Drop gam) {
	...
	public void render(float delta) {
		...
		game.font.draw(game.batch, "Score board", 200, 125);
		game.font.draw(game.batch, "1...", 200, 100);
		game.font.draw(game.batch, "1...", 200, 75);
		game.font.draw(game.batch, "1...", 200, 50);
